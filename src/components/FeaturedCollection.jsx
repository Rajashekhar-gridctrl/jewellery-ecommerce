  ...
  const collections = [
    {
      ...
      link: "https://www.tanishq.co.in/shop/dailywear-earrings?lang=en_IN",
    },
    {
    ...
    },
    {
      ...
      link: "https://www.tanishq.co.in/shop/dailywear-chains?lang=en_IN",
    },
  ];

  return (
    <section className="px-4 md:px-16 mt-32">
      <div className="text-center mb-10">
        <h3 className="text-3xl md:text-5xl font-semibold">Ramya's Collections</h3>
